...
--output_dir /root/vepfs/isaacsim/workdir/3dfm/taobao_RetroOffice_zedx01 \
...
--data_dir /root/vepfs/isaacsim/workdir/3dfm/taobao_RetroOffice_zedx01 \
--save_dir /root/vepfs/isaacsim/workdir/3dfm/taobao_RetroOffice_zedx01/vis \
--show_num 4
