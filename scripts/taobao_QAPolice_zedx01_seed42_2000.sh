...
--data_dir /root/vepfs/isaacsim/workdir/3dfm/taobao_QAPolice_zedx01_seed42_2000 \
--save_dir /root/vepfs/isaacsim/workdir/3dfm/taobao_QAPolice_zedx01_seed42_2000/vis \
--show_num 4
